...
(function () {
  ...
  const SLBCharts = {
    ...
    colors: {
      primary: '#0c8ee7',
      primaryLight: 'rgba(12, 142, 231, 0.14)',
      accent: '#0891b2',
      accentLight: 'rgba(8, 145, 178, 0.14)',
      success: '#10b981',
      warning: '#f59e0b',
      error: '#ef4444',
      gray: '#94a3b8',
      palette: ['#0c8ee7', '#0891b2', '#10b981', '#f59e0b', '#8b5cf6', '#36aaf5', '#0b4f8a']
    },
    ...
    radar(canvasId, opts) {
      ...
      if (!ctx) return null;
      // Parent container must set explicit height; fill it without aspect distortion.
        ...
        options: {
          ...
          scales: {
            r: {
              ...
              grid: { color: 'rgba(12, 142, 231, 0.10)' },
              angleLines: { color: 'rgba(12, 142, 231, 0.10)' },
    ...
    doughnut(canvasId, opts) {
      ...
      return new Chart(ctx, {
        ...
        options: {
          responsive: true,
          // Parent gives a square box; fill it without forcing a flattened ratio.
          maintainAspectRatio: false,
          cutout: '65%',
          layout: { padding: 8 },
          plugins: {
