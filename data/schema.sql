...
-- ============================================================
-- LLM 模型注册表（API Key 只保存 Fernet 密文）
-- ============================================================
...
CREATE INDEX IF NOT EXISTS idx_llm_models_selection
    ON llm_models(enabled, public_visible, priority);

-- ============================================================
-- 每次提交的模型评审明细
-- ============================================================
CREATE TABLE IF NOT EXISTS submission_judgments (
...
CREATE INDEX IF NOT EXISTS idx_submission_judgments_sid
    ON submission_judgments(sid);
